...
public class RestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvMain = (ListView) findViewById(R.id.listView_rest);
    ...
    void fillData() {
        ...
        events.add(new Event(-5, 10, -5, 1,R.drawable.ic_hamburger,2, "Поесть в BurgerKing", MainActivity.createAccessIndicatorForEvent(2)));
        events.add(new Event(-8, 15, -5, 1,R.drawable.ic_pizza,2, "Заказать пиццу", MainActivity.createAccessIndicatorForEvent(2)));
        events.add(new Event(-8, 15, -5, 1,R.drawable.ic_food_serving,2, "Поесть в ресторане", MainActivity.createAccessIndicatorForEvent(2)));
    }
}